ExternalProject_Add(vulkan
    ...
    CONFIGURE_COMMAND ${EXEC} CONF=1 cmake -H<SOURCE_DIR> -B<BINARY_DIR>
        ${cmake_conf_args}
        -DVULKAN_HEADERS_INSTALL_DIR=${PACKAGES_INSTALL_PREFIX}
        -DBUILD_TESTS=OFF
        -DENABLE_WERROR=OFF
        ${vulkan_asm}
    ...
    INSTALL_COMMAND ${CMAKE_COMMAND} -E copy <BINARY_DIR>/loader/libvulkan.a ${PACKAGES_INSTALL_PREFIX}/lib/libvulkan.a
            COMMAND ${CMAKE_COMMAND} -E copy <BINARY_DIR>/loader/vulkan_own.pc ${PACKAGES_INSTALL_PREFIX}/lib/pkgconfig/vulkan.pc
